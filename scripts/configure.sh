...
echo "...................................................."
echo "...................................................."
echo "...................> Start SimplePay Configure"
echo "...................................................."
echo "...................> Preparing SimplePay Environment"
...
if [ -f /var/lib/mysql/simplepay/db.opt ]
then
    ...
    mysql -uroot -e "CREATE DATABASE simplepay;"
fi
...
mv /tmp/source-file/nginx/simplepay.local.conf /etc/nginx/sites-enabled/
mv /tmp/source-file/nginx/* /etc/nginx/


mkdir /etc/ssl/simplepay.com
openssl req -x509 -nodes -days 365 -newkey rsa:2048 -nodes -subj "/C=UA/ST=Kiev/L=Kiev/O=Company/CN=simplepay.com.local/emailAddress=coolbob.coolbob@gmail.com" -keyout /etc/ssl/simplepay.com/simplepay.com.key -out /etc/ssl/simplepay.com/simplepay.com.csr
...
mkdir /var/log/simplepay
chown www-data:www-data /var/log/simplepay
