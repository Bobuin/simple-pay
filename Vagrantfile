...
#	config.vm.synced_folder $projectFolderPath, "/var/www/simplepay", create: true, :nfs => {:mount_options => ["dmode=777", "fmode=777","nfsvers=4"]}, type: "nfs"
#	config.vm.synced_folder $shareFolderPath,   "/tmp/share",      create: true, :nfs => {:mount_options => ["dmode=777", "fmode=777","nfsvers=4"]}, type: "nfs"
	config.vm.synced_folder $projectFolderPath, "/var/www/simplepay", create: true, :mount_options => ["dmode=777", "fmode=777"]
